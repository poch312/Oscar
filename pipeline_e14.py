...
def _detectar_cajas_firma(gris: np.ndarray) -> list[tuple[int, int, int, int]]:
    ...
    por contornos. Autodetecta el layout: nacional = 6 cajas (3×2),
...
def _auditar_firmas_jurados(doc, acta: ActaE14, cfg: Config, out: Path,
    ...
    if len(cajas) in (4, 6):
        ...
        # Fallback: grilla fija 2×3 sobre la franja 60-95%
...
def procesar_pdf_pasada1(pdf_path: Path, reco: Reconocedor,
    ...
    try:
        ...
        # Guardar hallazgos ANTES de los early-return para no perderlos
        ...
        if pag_votos is None:
            ...
            # "PÁGINA NO DIGITALIZADA") → hallazgo familia I en pasada 2.
