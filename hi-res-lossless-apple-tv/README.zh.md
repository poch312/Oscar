...
> 🌐 [Español](README.md) · [English](README.en.md) · **中文** · [हिन्दी](README.hi.md) · [日本語](README.ja.md) · [Português](README.pt.md)
...
所用 Apple TV 的“设置 → 通用 → 关于本机”界面：型号 **A2843（128 GB）**，**tvOS 27.0（24J361）**。序列号和网络信息已隐藏。
